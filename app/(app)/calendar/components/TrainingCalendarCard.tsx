...
export default function TrainingCalendarCard({ weekLabel, rangeLabel, statusText, totalWeeks, onPrevious, onNext }: TrainingCalendarCardProps) {
  return (
    <View style={styles.card}>
      ...
      <View style={styles.mainRow}>
        <TouchableOpacity onPress={onPrevious} accessibilityLabel="Previous week" style={styles.navButton}><Text style={[styles.navText, styles.previous]}>‹</Text></TouchableOpacity>
        ...
        <TouchableOpacity onPress={onNext} accessibilityLabel="Next week" style={styles.navButton}><Text style={[styles.navText, styles.next]}>›</Text></TouchableOpacity>
      </View>
